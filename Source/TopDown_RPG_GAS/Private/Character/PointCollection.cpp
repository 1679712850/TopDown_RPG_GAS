...
#include "Character/PointCollection.h"
	...
	float YawOverride)
{
	...
	for (USceneComponent* Pt : ImmutablePts)
	{
		...
		UAuraAbilitySystemBlueprintLibrary::GetLivePlayersWithinRadius(this, IgnoreActors, TArray<AActor*>(), 1500.f, GetActorLocation());
